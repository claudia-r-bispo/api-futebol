...
//        return new FootballMatchDTO(
//                saved.getId(),
//                saved.getHomeClub() != null ? saved.getHomeClub().getId() : null,
//                saved.getClubVisitor() != null ? saved.getClubVisitor().getId() : null,
//                saved.getStadium() != null ? saved.getStadium().getId() : null,
//                saved.getDateTimeDeparture(),
//                saved.getHomeTeamGoals(),
//                saved.getGoalsVisitor()
//        );
//    }
//}
